    ...
    return (
        <div className="flex h-screen justify-between items-center self-stretch px-48 py-40 gap-8">
            <div className="flex flex-col justify-center items-start gap-[39px] flex-[1_0_0] p-2">
                ...
                <div onClick={() => {router.push('/signup')}} className="transition ease-in-out cursor-pointer hover:scale-[1.03] flex h-[45px] justify-center items-center gap-[12.022px] shrink-0 shadow-[0px_3.005px_3.005px_0px_rgba(255,255,255,0.40)_inset] px-[36.065px] py-[13px] rounded-[15025.717px] border-[1.503px] border-solid border-[#292929] bg-[#243f73]">
